...
def test_leg_rejects_non_positive_amounts():
  # Инвариант двойной записи: сумма проводки должна быть положительной.
  # Проверяется на конструкторе Leg -- невалидную сущность нельзя
  # создать, не только запостить.
