"""ISO 8583: разбор MTI и primary/secondary bitmap.

Возвращает MTI как 4-символьную ASCII-строку и список номеров DE, у которых
установлен бит присутствия. Сами значения полей остаются непрочитанными:
для каждого DE нужны его длина и формат из IFS партнёра.
"""
