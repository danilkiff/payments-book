"""BER-TLV-парсер для EMV (подмножество ISO/IEC 8825-1).

Достаточно для чтения ответов карты на SELECT, READ RECORD и содержимого
DE 55: одно- и двухбайтовые теги, short и long form длины, рекурсия
в constructed-теги (шаблоны).
"""
