...
% This template is optimized for a narrow field layout, not for wide figures in the main text.
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[note, below=7mm of step5] {Короткое пояснение под схемой. Если пояснение не помещается без тесноты, это уже не узкая схема для поля.};
\end{tikzpicture}
\end{document}
