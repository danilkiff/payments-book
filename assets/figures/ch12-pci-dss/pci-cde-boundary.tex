\begin{tikzpicture}[x=1cm,y=1cm]
	...
	\draw[fig/dashed] (5.8,-0.9) -- (2.1,-0.9);
		...
		\node[fig/note, text width=0.98\textwidth] at (0,-6.9) {Без сегментации соседние инфраструктурные сервисы и бизнес-системы тоже попадают в периметр PCI DSS, поэтому границы CDE всегда нужно проектировать как архитектурное решение, а не как список серверов.};
\end{tikzpicture}
