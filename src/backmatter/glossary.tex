...
\begin{longtable}{@{}p{4.5em}p{\dimexpr\linewidth-4.5em-2\tabcolsep\relax}@{}}
  ...
  \textbf{PWCB} & Purchase with Cashback, тип EMV-операции \enquote{покупка с~выдачей наличных} (Mastercard); кодируется тегом \texttt{0x9C} = \texttt{09}; синонимы: Наличные на кассе \\
...
\\
  ...
  \textbf{ФинЦЕРТ} & Центр мониторинга и~реагирования на компьютерные атаки в~кредитно-финансовой сфере Банка России; синонимы: FinCERT \\
